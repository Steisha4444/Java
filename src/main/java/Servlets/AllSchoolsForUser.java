...
@WebServlet(name = "AllSchoolsForUser", value = "/AllSchoolsForUser")
public class AllSchoolsForUser extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher rd = request.getRequestDispatcher("AllSchoolsForUser.jsp");
