...
@WebServlet(name = "AllRegionsForUser", value = "/AllRegionsForUser")
public class AllRegionsForUser extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher rd = request.getRequestDispatcher("AllRegionsForUser.jsp");
